package fhuz.unfiltered.demo.plan
...
import fhuz.unfiltered.demo.common.{JsonBody, JsonMapper}
import fhuz.unfiltered.demo.representation.CocktailRepresentation._
